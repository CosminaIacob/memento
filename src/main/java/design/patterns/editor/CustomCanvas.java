...
import design.patterns.commands.ColorCommand;
import design.patterns.commands.MoveCommand;
...
public class CustomCanvas extends java.awt.Canvas {
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                design.patterns.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
